    ...
    <div class="container rounded border border-dark" style="background-color: white;">
        ...
        <p class="lead">
            <div class="alert alert-danger border border-danger" role="alert"> 
                <h2 class="alert-heading text-center"><i class="fas fa-exclamation-triangle" style="color:red;"></i>&nbsp Advertencia &nbsp<i class="fas fa-exclamation-triangle" style="color:red;"></i></h2>
